...
namespace VBvh
{
  ...
  std::string getCompilerName()
  {
    ...
    version += UtilString::stringOf(icc_mayor);
    version += "." + UtilString::stringOf(icc_minor);
#if defined(__INTEL_COMPILER_UPDATE)
    version += "." + UtilString::stringOf(__INTEL_COMPILER_UPDATE);
#endif
    return version;
   ...
   /* std::string version = UtilString::stringOf(_MSC_FULL_VER);
    version.insert(4,".");
    version.insert(9,".");
    version.insert(2,".");*/
