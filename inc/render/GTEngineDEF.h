...
namespace gte
{
	typedef Eigen::Matrix<float, 2, 1, Eigen::DontAlign> EVector2;
	typedef Eigen::Matrix<float, 3, 1, Eigen::DontAlign> EVector3;
	typedef Eigen::Matrix<float, 4, 1, Eigen::DontAlign> EVector4;
	typedef Eigen::Matrix<float, 3, 3, Eigen::DontAlign> EMatrix3x3;
	typedef Eigen::Matrix<float, 4, 4, Eigen::DontAlign> EMatrix4x4;
}