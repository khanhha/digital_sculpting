#ifndef SCULPT_PLATFORM_H
#define SCULPT_PLATFORM_H
#include <stddef.h>
#include <assert.h>
#include <cstdlib>
#include <cstdio>
...
#define THROW_RUNTIME_ERROR(str) \
  throw std::runtime_error(std::string(__FILE__) + " (" + UtilString::stringOf(__LINE__)+ "): " + std::string(str));
...
#include "VBvh/common/sys/constants.h"
