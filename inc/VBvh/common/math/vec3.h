#ifndef SCULPT_VEC3_H
#define SCULPT_VEC3_H
...
VBVH_BEGIN_NAMESPACE
  ...
  template<typename T> __forceinline Vec3<T> smin(const Vec3<T>& a, const Vec3<T>& b) { return Vec3<T>(smin(a.x, b.x), smin(a.y, b.y), smin(a.z, b.z)); }
  template<typename T> __forceinline Vec3<T> smax(const Vec3<T>& a, const Vec3<T>& b) { return Vec3<T>(smax(a.x, b.x), smax(a.y, b.y), smax(a.z, b.z)); }
  ...
  template<typename T> __forceinline T reduce_min( const Vec3<T>& a ) { return smin(a.x, a.y, a.z); }
  template<typename T> __forceinline T reduce_max( const Vec3<T>& a ) { return smax(a.x, a.y, a.z); }
